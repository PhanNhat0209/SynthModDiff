...
from main import dist_util, logger
from main.bratsloader import BRATSDataset, BRATSDataset3D
from main.isicloader import ISICDataset
from main.custom_dataset_loader import CustomDataset
import torchvision.utils as vutils
from main.utils import staple
from main.script_util import (
    NUM_CLASSES,
...
def main():
    ...
    if args.data_name == 'ISIC':
        ...
        tran_list = [transforms.ToPILImage(), transforms.Resize((args.image_size, args.image_size)), transforms.ToTensor()]
        transform_test = transforms.Compose(tran_list)
...
def create_argparser():
    defaults = dict(
        ...
        batch_size=1,
        use_ddim=False,
        model_path="./output_model/savedmodel035000.pt",         #path to pretrain model
